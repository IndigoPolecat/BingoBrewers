...
import com.github.indigopolecat.bingobrewers.gui.CrystalHollowsHud;
...
import static com.github.indigopolecat.bingobrewers.network.PacketProcessing.processPacket;
...
public class ServerConnection extends Listener implements Runnable {
    ...
    private void connection() throws Exception {
        ...
        if (BingoBrewers.TEST_INSTANCE) {
            ...
            BingoBrewers.client.connect(8000, "bingobrewers.com", 9090, 9191);
        } else {
            BingoBrewers.client.connect(8000, "bingobrewers.com", 8080, 7070);
        }
